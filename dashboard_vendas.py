...
with tab2:
    ...
    with col1: 
        ...
        x="mes",
        y="faturamento",
        color="vendedor",   # 🔥 separa as linhas por vendedor
        markers=False
        )
    ...
    with col1:
        ...
        x="mes",
        y="faturamento",
        color="equipe",   # 🔥 separa as linhas por vendedor
        markers=False
        )
...
with tab3:
    ...
    with col1g:
        ...
        x="mes",
        y="faturamento",
        color="categoria_servico",   # 🔥 separa as linhas por vendedor
        markers=False
        )
...
with tab4:
    ...
    fig = px.choropleth_mapbox(
        ...
        geojson=geojson,
        locations="estado",
        featureidkey="properties.sigla",  # deve bater com a coluna "estado" do seu df
        color=metrica_geo,
        hover_name="estado",
        hover_data={
            "faturamento": ":,.2f",
